...
| --- | --- | --- |
| `M2-C1` | pending | Align M2 contract wording with actual seam-vs-PTY state. |
| `M2-C2` | pending | Implement Unix PTY/process transport adapter. |
| `M2-C3` | pending | Wire session lifecycle path required for PTY transport usage. |
| `M2-C4` | pending | Add deterministic headless bash evidence tests (spawn/read/resize/stop). |
| `M2-C5` | pending | Publish M2 closeout evidence and queue update. |
